(function ($) {
    ...
    if ($.fn.owlCarousel) {
        ...
        function welcomeSlide() {
            ...
            $('.welcome-slides .owl-prev').css({
                background: 'url(' + prevSlideImg + ')'
            });
            $('.welcome-slides .owl-next').css({
    ...
    if ($.fn.owlCarousel) {
        ...
        roomSlides.owlCarousel({
            ...
            smartSpeed: 1500,
            nav: true,
            navText: [('<i class="fa fa-long-arrow-left" aria-hidden="true"></i> قبلی'), ('بعدی <i class="fa fa-long-arrow-right" aria-hidden="true"></i>')]
        });
